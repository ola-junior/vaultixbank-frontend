  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900">
        ...
        <motion.div animate={{ scale: [1, 1.2, 1], rotate: [0, 90, 0] }} transition={{ duration: 20, repeat: Infinity }} className="absolute -top-40 -left-40 w-80 h-80 bg-blue-500 rounded-full opacity-30 blur-3xl" />
        <motion.div animate={{ scale: [1.2, 1, 1.2], rotate: [90, 0, 90] }} transition={{ duration: 15, repeat: Infinity }} className="absolute -bottom-40 -right-40 w-96 h-96 bg-indigo-500 rounded-full opacity-30 blur-3xl" />
        <motion.div animate={{ scale: [1, 1.3, 1] }} transition={{ duration: 18, repeat: Infinity }} className="absolute top-1/2 left-1/2 w-64 h-64 bg-purple-500 rounded-full opacity-20 blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="font-bold leading-tight mb-6" style={{ fontSize: 'clamp(2.5rem, 4vw, 3.5rem)' }}>
            Welcome<br />
            <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent">Back!</span>
          </motion.h1>
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="text-white/60 text-lg leading-relaxed mb-8">
            Access your account to manage your finances, send money instantly, and track all your transactions in one place.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="space-y-4 mb-8">
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 flex items-center gap-4 border border-white/10 hover:border-blue-400/30 transition-all duration-300 hover:translate-x-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white"><FaShieldAlt className="text-lg" /></div>
              <div><p className="text-white/90 font-semibold">Secure Login</p><p className="text-white/40 text-sm">Protected by 256-bit encryption</p></div>
            </div>
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 flex items-center gap-4 border border-white/10 hover:border-cyan-400/30 transition-all duration-300 hover:translate-x-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center text-white"><FaChartLine className="text-lg" /></div>
              <div><p className="text-white/90 font-semibold">Real-time Updates</p><p className="text-white/40 text-sm">Track your balance and transactions</p></div>
            </div>
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 flex items-center gap-4 border border-white/10 hover:border-indigo-400/30 transition-all duration-300 hover:translate-x-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white"><FaGlobe className="text-lg" /></div>
              <div><p className="text-white/90 font-semibold">24/7 Access</p><p className="text-white/40 text-sm">Bank anytime, anywhere</p></div>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="flex items-center gap-4">
            ...
            <div><div className="text-yellow-400 text-xs tracking-widest">★★★★★</div><p className="text-white/50 text-sm">Trusted by <span className="text-white/80 font-medium">1M+</span> users</p></div>
          </motion.div>
          ...
          <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 5, repeat: Infinity }} className="absolute top-20 right-8 bg-white/10 backdrop-blur-lg rounded-2xl px-4 py-3 hidden xl:block">
            <div className="flex items-center gap-3"><span className="text-2xl">🔐</span><div><p className="text-white text-xs font-medium">Secure Session</p><p className="text-white/40 text-[10px]">End-to-end encrypted</p></div></div>
          </motion.div>
          <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 6, repeat: Infinity, delay: 2 }} className="absolute bottom-20 right-8 bg-white/10 backdrop-blur-lg rounded-2xl px-4 py-3 hidden xl:block">
            <div className="flex items-center gap-3"><span className="text-2xl">⚡</span><div><p className="text-white text-xs font-medium">Quick Login</p><p className="text-white/40 text-[10px]">Access in seconds</p></div></div>
          </motion.div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">Don't have an account? <Link to="/register" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">Sign up</Link></p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input type="email" name="email" required value={formData.email} onChange={handleChange} className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-2 focus:ring-indigo-500 outline-none transition dark:text-white" placeholder="Enter your email" />
              </div>
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300"><FaLock className="inline mr-2 text-indigo-500" />Password</label>
                  <Link to="/forgot-password" className="text-xs text-indigo-600 dark:text-indigo-400 hover:underline">Forgot Password?</Link>
                </div>
                <div className="relative">
                  <input type={showPassword ? "text" : "password"} name="password" required value={formData.password} onChange={handleChange} className="w-full px-4 py-3 pr-12 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-2 focus:ring-indigo-500 outline-none transition dark:text-white" placeholder="Enter your password" />
              ...
              <button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl disabled:opacity-50">
            ...
            <div className="grid grid-cols-3 gap-3">
              <button onClick={handleGoogleLogin} disabled={oauthLoading.google} className="flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-50">{oauthLoading.google ? <div className="animate-spin h-5 w-5 border-2 border-red-500 border-t-transparent rounded-full" /> : <FaGoogle className="text-red-500 text-xl" />}</button>
              <button onClick={handleFacebookLogin} disabled={oauthLoading.facebook} className="flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-50">{oauthLoading.facebook ? <div className="animate-spin h-5 w-5 border-2 border-blue-600 border-t-transparent rounded-full" /> : <FaFacebook className="text-blue-600 text-xl" />}</button>
              <button onClick={handleTwitterLogin} disabled={oauthLoading.twitter} className="flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-50">{oauthLoading.twitter ? <div className="animate-spin h-5 w-5 border-2 border-sky-500 border-t-transparent rounded-full" /> : <FaTwitter className="text-sky-500 text-xl" />}</button>
            </div>
            ...
            <div className="mt-8 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-xl border border-indigo-200 dark:border-indigo-800">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">Demo Credentials</p>
                <button onClick={fillDemoCredentials} className="text-xs bg-indigo-600 text-white px-3 py-1 rounded-lg hover:bg-indigo-700">Fill Demo</button>
              </div>
              <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <p><FaEnvelope className="inline mr-2 text-indigo-500 text-xs" />Email: john@example.com</p>
                <p><FaLock className="inline mr-2 text-indigo-500 text-xs" />Password: password123</p>
              </div>
            </div>
            <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-6">By signing in, you agree to our <a href="#" className="text-indigo-600 hover:underline">Terms</a> and <a href="#" className="text-indigo-600 hover:underline">Privacy Policy</a>.</p>
          </motion.div>
        </div>
      </div>
