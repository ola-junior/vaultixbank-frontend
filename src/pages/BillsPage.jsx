...
// Add these imports at the top of BillsPage.jsx
import {
  ...
  FaChevronRight, FaHotel, FaCar, FaFilm,
  FaMusic, FaUtensils, FaGift, FaHeartbeat,
  FaShoppingBag, FaTicketAlt
} from 'react-icons/fa';
import { MdSportsSoccer, MdLocalGroceryStore, MdFlightTakeoff } from 'react-icons/md';

// Complete BILL_CATEGORIES object
export const BILL_CATEGORIES = {
  airtime: {
    label: 'Airtime', icon: FaMobileAlt, gradient: ['#6366f1', '#8b5cf6'], color: '#8b5cf6',
    description: 'Buy airtime for any Nigerian network',
    recipientLabel: 'Phone Number', recipientPlaceholder: '08012345678',
    recipientType: 'tel', recipientLength: 11, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [100, 200, 500, 1000, 2000, 5000], verifyRecipient: false,
  },
  data: {
    label: 'Data', icon: FaWifi, gradient: ['#3b82f6', '#0ea5e9'], color: '#3b82f6',
    description: 'Buy internet data bundles',
    recipientLabel: 'Phone Number', recipientPlaceholder: '08012345678',
    recipientType: 'tel', recipientLength: 11, hasPlans: true, hasFreeAmount: false,
    quickAmounts: [], verifyRecipient: false,
  },
  tv: {
    label: 'Cable TV', icon: FaTv, gradient: ['#f59e0b', '#d97706'], color: '#f59e0b',
    description: 'Pay your TV subscription',
    recipientLabel: 'Smartcard / IUC Number', recipientPlaceholder: 'Enter smartcard number',
    recipientType: 'text', recipientLength: 10, hasPlans: true, hasFreeAmount: false,
    quickAmounts: [], verifyRecipient: true,
  },
  electricity: {
    label: 'Electricity', icon: FaBolt, gradient: ['#eab308', '#ca8a04'], color: '#eab308',
    description: 'Pay electricity bills & buy prepaid tokens',
    recipientLabel: 'Meter Number', recipientPlaceholder: 'Enter meter number',
    recipientType: 'text', recipientLength: 11, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [1000, 2000, 5000, 10000, 20000], verifyRecipient: true, showToken: true,
  },
  water: {
    label: 'Water', icon: FaWater, gradient: ['#06b6d4', '#0284c7'], color: '#06b6d4',
    description: 'Pay water bills',
    recipientLabel: 'Account / Bill Number', recipientPlaceholder: 'Enter account number',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [2000, 5000, 10000], verifyRecipient: true,
  },
  education: {
    label: 'Education', icon: FaGraduationCap, gradient: ['#8b5cf6', '#6d28d9'], color: '#8b5cf6',
    description: 'Pay exam fees — WAEC, NECO, JAMB & more',
    recipientLabel: 'Registration Number', recipientPlaceholder: 'Enter exam registration number',
    recipientType: 'text', recipientLength: 10, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [], verifyRecipient: false,
  },
  betting: {
    label: 'Betting', icon: MdSportsSoccer, gradient: ['#10b981', '#059669'], color: '#10b981',
    description: 'Fund your betting account instantly',
    recipientLabel: 'User ID / Username', recipientPlaceholder: 'Enter your betting user ID',
    recipientType: 'text', recipientLength: 6, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [500, 1000, 2000, 5000, 10000], verifyRecipient: true,
  },
  internet: {
    label: 'Internet', icon: FaGlobe, gradient: ['#6366f1', '#4f46e5'], color: '#6366f1',
    description: 'Pay broadband & ISP subscriptions',
    recipientLabel: 'Account Number', recipientPlaceholder: 'Enter account number',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [3000, 5000, 10000, 15000, 20000], verifyRecipient: true,
  },
  shopping: {
    label: 'Shopping', icon: FaShoppingBag, gradient: ['#10b981', '#047857'], color: '#10b981',
    description: 'Pay for online shopping orders',
    recipientLabel: 'Order Number', recipientPlaceholder: 'Enter order reference',
    recipientType: 'text', recipientLength: 10, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [5000, 10000, 20000, 50000], verifyRecipient: false,
  },
  gaming: {
    label: 'Gaming', icon: FaGamepad, gradient: ['#a855f7', '#7c3aed'], color: '#a855f7',
    description: 'Buy game credits & subscriptions',
    recipientLabel: 'Gamer ID', recipientPlaceholder: 'Enter gamer ID/username',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [1000, 2000, 5000, 10000], verifyRecipient: true,
  },
  events: {
    label: 'Events', icon: FaTicketAlt, gradient: ['#f43f5e', '#e11d48'], color: '#f43f5e',
    description: 'Book event tickets',
    recipientLabel: 'Booking Reference', recipientPlaceholder: 'Enter booking reference',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [5000, 10000, 25000, 50000], verifyRecipient: false,
  },
  flights: {
    label: 'Flights', icon: MdFlightTakeoff, gradient: ['#06b6d4', '#0284c7'], color: '#06b6d4',
    description: 'Pay for flight bookings',
    recipientLabel: 'Booking Reference/PNR', recipientPlaceholder: 'Enter PNR number',
    recipientType: 'text', recipientLength: 6, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [50000, 100000, 200000, 500000], verifyRecipient: true,
  },
  hotels: {
    label: 'Hotels', icon: FaHotel, gradient: ['#8b5cf6', '#6d28d9'], color: '#8b5cf6',
    description: 'Pay for hotel reservations',
    recipientLabel: 'Booking ID', recipientPlaceholder: 'Enter booking ID',
    recipientType: 'text', recipientLength: 10, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [20000, 50000, 100000, 200000], verifyRecipient: true,
  },
  travel: {
    label: 'Travel', icon: FaGlobe, gradient: ['#3b82f6', '#0ea5e9'], color: '#3b82f6',
    description: 'Pay for travel packages',
    recipientLabel: 'Booking Reference', recipientPlaceholder: 'Enter booking reference',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [50000, 100000, 200000, 500000], verifyRecipient: false,
  },
  carRental: {
    label: 'Car Rental', icon: FaCar, gradient: ['#f59e0b', '#d97706'], color: '#f59e0b',
    description: 'Pay for car rentals',
    recipientLabel: 'Reservation Number', recipientPlaceholder: 'Enter reservation number',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [20000, 50000, 100000], verifyRecipient: true,
  },
  movies: {
    label: 'Movies', icon: FaFilm, gradient: ['#ec4899', '#db2777'], color: '#ec4899',
    description: 'Book movie tickets',
    recipientLabel: 'Booking ID', recipientPlaceholder: 'Enter booking ID',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [2000, 5000, 10000], verifyRecipient: false,
  },
  music: {
    label: 'Music', icon: FaMusic, gradient: ['#10b981', '#059669'], color: '#10b981',
    description: 'Pay for music subscriptions',
    recipientLabel: 'Account ID', recipientPlaceholder: 'Enter account ID',
    recipientType: 'text', recipientLength: 10, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [900, 2000, 5000], verifyRecipient: false,
  },
  dining: {
    label: 'Dining', icon: FaUtensils, gradient: ['#f97316', '#ea580c'], color: '#f97316',
    description: 'Pay for restaurant bookings',
    recipientLabel: 'Reservation ID', recipientPlaceholder: 'Enter reservation ID',
    recipientType: 'text', recipientLength: 8, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [5000, 10000, 20000, 50000], verifyRecipient: false,
  },
  gifts: {
    label: 'Gifts', icon: FaGift, gradient: ['#f43f5e', '#e11d48'], color: '#f43f5e',
    description: 'Buy gift cards',
    recipientLabel: 'Recipient Email', recipientPlaceholder: 'Enter recipient email',
    recipientType: 'email', recipientLength: 50, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [5000, 10000, 20000, 50000], verifyRecipient: false,
  },
  healthcare: {
    label: 'Healthcare', icon: FaHeartbeat, gradient: ['#ef4444', '#dc2626'], color: '#ef4444',
    description: 'Pay for medical services',
    recipientLabel: 'Patient ID', recipientPlaceholder: 'Enter patient ID',
    recipientType: 'text', recipientLength: 10, hasPlans: false, hasFreeAmount: true,
    quickAmounts: [10000, 20000, 50000, 100000], verifyRecipient: true,
  },
};
