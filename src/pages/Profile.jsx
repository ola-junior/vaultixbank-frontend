...
import { 
  ...
  FaShieldAlt, FaKey, FaImage, FaSync
} from 'react-icons/fa';
...
const Profile = () => {
  ...
  const getCurrentBanner = useCallback(() => {
    ...
    // User's custom banner from state (fresh from backend)
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      // 🔥 CRITICAL: Update user with current state (not localStorage)
    ...
    <div className="max-w-4xl mx-auto space-y-6 px-4 sm:px-0">
      ...
      >
        ...
        <div className="relative h-32 sm:h-36 md:h-44">
          ...
          {/* 🔥 FIXED: Very subtle gradient that NEVER covers text */}
