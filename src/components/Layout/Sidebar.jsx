...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { 
      ...
      label: 'Bills',
      subItems: [
        { path: '/bills/airtime', icon: FaMobileAlt, label: 'Airtime' },
        { path: '/bills/data', icon: FaWifi, label: 'Data' },
    ...
    <>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm">
          <Link to="/profile" onClick={onClose} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
